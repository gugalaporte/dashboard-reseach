...
export interface IEndpoints {
    ...
    'GET /informationProtection/bitlocker/recoveryKeys': Operation<'/informationProtection/bitlocker/recoveryKeys', 'get'>;
    'GET /informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey-id}': Operation<'/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey-id}', 'get'>;
}
/**
 * `GET /informationProtection/bitlocker`
 *
 */
export declare function get(params?: IEndpoints['GET /informationProtection/bitlocker']['parameters']): EndpointRequest<IEndpoints['GET /informationProtection/bitlocker']['response']>;
export declare const recoveryKeys: {
    /**
     ...
     */
    list: (params?: IEndpoints["GET /informationProtection/bitlocker/recoveryKeys"]["parameters"]) => EndpointRequest<IEndpoints["GET /informationProtection/bitlocker/recoveryKeys"]["response"]>;
    /**
     ...
     */
    get: (params?: IEndpoints["GET /informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey-id}"]["parameters"]) => EndpointRequest<IEndpoints["GET /informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey-id}"]["response"]>;
};
