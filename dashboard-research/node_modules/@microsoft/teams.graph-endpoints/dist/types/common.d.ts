...
export type ExtractParameters<T> = 'parameters' extends keyof T ? UnionToIntersection<{
    [K in keyof T['parameters']]-?: T['parameters'][K];
}[keyof T['parameters']]> : {};
export type ExtractRequestBody<T> = 'requestBody' extends keyof T ? 'content' extends keyof T['requestBody'] ? 'application/json' extends keyof T['requestBody']['content'] ? T['requestBody']['content']['application/json'] : {
    data: {
...
export type KnownJsonResponseTypes = 'application/json' | 'application/octocat-stream' | 'application/scim+json' | 'text/html' | 'text/plain';
...
export type GetContentKeyIfPresent<T> = 'content' extends keyof T ? DataType<T['content']> : DataType<T>;
export type DataType<T> = {
    [K in KnownJsonResponseTypes & keyof T]: T[K];
}[KnownJsonResponseTypes & keyof T];
export type ExtractResponse<R> = 'responses' extends keyof R ? SuccessResponseDataType<R['responses']> extends never ? RedirectResponseDataType<R['responses']> extends never ? EmptyResponseDataType<R['responses']> : RedirectResponseDataType<R['responses']> : SuccessResponseDataType<R['responses']> : unknown;
