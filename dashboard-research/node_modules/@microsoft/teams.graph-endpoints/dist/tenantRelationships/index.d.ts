 ...
 *
 */
export declare function list(params?: IEndpoints['GET /tenantRelationships']['parameters']): EndpointRequest<IEndpoints['GET /tenantRelationships']['response']>;
/**
 * `PATCH /tenantRelationships`
 *
 */
export declare function update(body: IEndpoints['PATCH /tenantRelationships']['body']): EndpointRequest<IEndpoints['PATCH /tenantRelationships']['response']>;
