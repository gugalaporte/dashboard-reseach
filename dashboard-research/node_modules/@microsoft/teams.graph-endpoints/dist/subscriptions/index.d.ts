...
export interface IEndpoints {
    'DELETE /subscriptions/{subscription-id}': Operation<'/subscriptions/{subscription-id}', 'delete'>;
    ...
    'POST /subscriptions/{subscription-id}/reauthorize': Operation<'/subscriptions/{subscription-id}/reauthorize', 'post'>;
}
/**
 ...
 */
export declare function del(params?: IEndpoints['DELETE /subscriptions/{subscription-id}']['parameters']): EndpointRequest<IEndpoints['DELETE /subscriptions/{subscription-id}']['response']>;
/**
 * `GET /subscriptions`
 *
 ...
 */
export declare function list(params?: IEndpoints['GET /subscriptions']['parameters']): EndpointRequest<IEndpoints['GET /subscriptions']['response']>;
/**
 ...
 */
export declare function get(params?: IEndpoints['GET /subscriptions/{subscription-id}']['parameters']): EndpointRequest<IEndpoints['GET /subscriptions/{subscription-id}']['response']>;
/**
 ...
 */
export declare function update(body: IEndpoints['PATCH /subscriptions/{subscription-id}']['body'], params?: IEndpoints['PATCH /subscriptions/{subscription-id}']['parameters']): EndpointRequest<IEndpoints['PATCH /subscriptions/{subscription-id}']['response']>;
/**
 * `POST /subscriptions`
 *
 ...
 */
export declare function create(body: IEndpoints['POST /subscriptions']['body']): EndpointRequest<IEndpoints['POST /subscriptions']['response']>;
export declare const reauthorize: {
     ...
     */
    create: (params?: IEndpoints["POST /subscriptions/{subscription-id}/reauthorize"]["parameters"]) => EndpointRequest<IEndpoints["POST /subscriptions/{subscription-id}/reauthorize"]["response"]>;
};
