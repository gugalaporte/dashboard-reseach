 ...
 *
 */
export declare function get(params?: IEndpoints['GET /identityGovernance']['parameters']): EndpointRequest<IEndpoints['GET /identityGovernance']['response']>;
/**
 * `PATCH /identityGovernance`
 *
 */
export declare function update(body: IEndpoints['PATCH /identityGovernance']['body']): EndpointRequest<IEndpoints['PATCH /identityGovernance']['response']>;
