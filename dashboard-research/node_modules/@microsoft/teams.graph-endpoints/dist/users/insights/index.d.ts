 ...
 *
 */
export declare function del(params?: IEndpoints['DELETE /users/{user-id}/insights']['parameters']): EndpointRequest<IEndpoints['DELETE /users/{user-id}/insights']['response']>;
/**
 ...
 */
export declare function list(params?: IEndpoints['GET /users/{user-id}/insights']['parameters']): EndpointRequest<IEndpoints['GET /users/{user-id}/insights']['response']>;
/**
 * `PATCH /users/{user-id}/insights`
 *
 */
export declare function update(body: IEndpoints['PATCH /users/{user-id}/insights']['body'], params?: IEndpoints['PATCH /users/{user-id}/insights']['parameters']): EndpointRequest<IEndpoints['PATCH /users/{user-id}/insights']['response']>;
