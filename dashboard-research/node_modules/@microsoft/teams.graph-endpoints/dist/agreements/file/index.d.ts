 ...
 *
 */
export declare function del(params?: IEndpoints['DELETE /agreements/{agreement-id}/file']['parameters']): EndpointRequest<IEndpoints['DELETE /agreements/{agreement-id}/file']['response']>;
/**
 ...
 */
export declare function get(params?: IEndpoints['GET /agreements/{agreement-id}/file']['parameters']): EndpointRequest<IEndpoints['GET /agreements/{agreement-id}/file']['response']>;
/**
 * `PATCH /agreements/{agreement-id}/file`
 *
 */
export declare function update(body: IEndpoints['PATCH /agreements/{agreement-id}/file']['body'], params?: IEndpoints['PATCH /agreements/{agreement-id}/file']['parameters']): EndpointRequest<IEndpoints['PATCH /agreements/{agreement-id}/file']['response']>;
