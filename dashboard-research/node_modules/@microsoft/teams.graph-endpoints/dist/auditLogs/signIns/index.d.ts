...
export interface IEndpoints {
    ...
    'POST /auditLogs/signIns/confirmCompromised': Operation<'/auditLogs/signIns/confirmCompromised', 'post'>;
 ...
 *
 */
export declare function del(params?: IEndpoints['DELETE /auditLogs/signIns/{signIn-id}']['parameters']): EndpointRequest<IEndpoints['DELETE /auditLogs/signIns/{signIn-id}']['response']>;
/**
 ...
 */
export declare function list(params?: IEndpoints['GET /auditLogs/signIns']['parameters']): EndpointRequest<IEndpoints['GET /auditLogs/signIns']['response']>;
/**
 ...
 */
export declare function get(params?: IEndpoints['GET /auditLogs/signIns/{signIn-id}']['parameters']): EndpointRequest<IEndpoints['GET /auditLogs/signIns/{signIn-id}']['response']>;
/**
 * `PATCH /auditLogs/signIns/{signIn-id}`
 *
 */
export declare function update(body: IEndpoints['PATCH /auditLogs/signIns/{signIn-id}']['body'], params?: IEndpoints['PATCH /auditLogs/signIns/{signIn-id}']['parameters']): EndpointRequest<IEndpoints['PATCH /auditLogs/signIns/{signIn-id}']['response']>;
/**
 * `POST /auditLogs/signIns`
 *
 */
export declare function create(body: IEndpoints['POST /auditLogs/signIns']['body']): EndpointRequest<IEndpoints['POST /auditLogs/signIns']['response']>;
export declare const confirmCompromised: {
    /**
     ...
     */
    create: (body: IEndpoints["POST /auditLogs/signIns/confirmCompromised"]["body"]) => EndpointRequest<IEndpoints["POST /auditLogs/signIns/confirmCompromised"]["response"]>;
};
export declare const confirmSafe: {
    /**
     ...
     */
    create: (body: IEndpoints["POST /auditLogs/signIns/confirmSafe"]["body"]) => EndpointRequest<IEndpoints["POST /auditLogs/signIns/confirmSafe"]["response"]>;
};
export declare const dismiss: {
     ...
     */
    create: (body: IEndpoints["POST /auditLogs/signIns/dismiss"]["body"]) => EndpointRequest<IEndpoints["POST /auditLogs/signIns/dismiss"]["response"]>;
};
